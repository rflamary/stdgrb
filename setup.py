...
setup(
    ...
    description='Gurobi solvers for standard dense problems (LP,QP)',  # Required
    ...
    url='https://github.com/rflamary/stdgrb',  # Optional
    ...
    keywords='numerical optimization',  # Optional
    ...
    install_requires=['cvxopt'],  # Optional
